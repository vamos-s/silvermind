      ...
      <div className="max-w-2xl mx-auto">
        ...
        {gameState === 'menu' && (
          ...
          >
            ...
            <div className="bg-emerald-50 rounded-xl p-4 mb-6 text-left">
              <h3 className="font-bold text-gray-800 dark:text-white mb-2">{t('locationMemory.levelInfo', 'Level Settings')}:</h3>
          ...
          <>
            ...
            <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-lg p-6 mb-6">
              <div className="flex justify-between items-center">
                <div>
                  <p className="text-gray-700 dark:text-gray-300 text-sm font-medium">{t('locationMemory.level', 'Level')}</p>
                  <p className="text-xl md:text-2xl lg:text-3xl font-bold text-emerald-600">{level}/{MAX_LEVELS}</p>
                </div>
                <div>
                  <p className="text-gray-700 dark:text-gray-300 text-sm font-medium">{t('locationMemory.score', 'Score')}</p>
                  <p className="text-xl md:text-2xl lg:text-3xl font-bold text-teal-600">{totalScore}</p>
                </div>
                <div>
                  <p className="text-gray-700 dark:text-gray-300 text-sm font-medium">{t('locationMemory.timeLeft', 'Time Left')}</p>
                  <p className={`text-2xl md:text-3xl lg:text-4xl font-bold ${timeLeft <= 10 ? 'text-red-500' : 'text-emerald-600'}`}>
                    {timeLeft}s
                  </p>
                </div>
              </div>
            ...
            <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-lg p-8 mb-6 text-center">
              ...
              <button
                ...
                className="w-full mt-6 bg-gradient-to-r from-emerald-500 to-teal-500 text-white text-lg md:text-xl lg:text-2xl font-bold py-4 rounded-xl hover:from-emerald-600 hover:to-teal-600 shadow-lg transition-all"
              >
        ...
        {gameState === 'levelComplete' && (
          ...
          >
            ...
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-emerald-600 mb-4">Level {level} Complete!</h2>
            <div className="bg-emerald-50 rounded-xl p-6 mb-6">
              ...
              <div className="grid grid-cols-2 gap-4 mt-4">
                <div>
                  <p className="text-gray-700 dark:text-gray-300 text-sm font-medium">{t('locationMemory.levelScore', 'Level Score')}</p>
                  <p className="text-xl md:text-2xl lg:text-3xl font-bold text-emerald-600">{score}</p>
                </div>
                <div>
                  <p className="text-gray-700 dark:text-gray-300 text-sm font-medium">{t('locationMemory.totalScore', 'Total Score')}</p>
                  <p className="text-xl md:text-2xl lg:text-3xl font-bold text-teal-600">{totalScore + score}</p>
                </div>
              </div>
            </div>
            <button
        ...
        {gameState === 'victory' && (
          ...
          >
            <div className="text-6xl mb-4">🎉</div>
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-emerald-600 mb-4">{t('locationMemory.victory', 'Congratulations!')}</h2>
            ...
            <div className="bg-emerald-50 rounded-xl p-6 mb-6">
              <p className="text-gray-700 dark:text-gray-300 text-sm font-medium">{t('locationMemory.finalScore', 'Final Score')}</p>
