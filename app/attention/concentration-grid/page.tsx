    ...
    <div className={`min-h-screen p-3 md:p-4 lg:p-8 transition-colors duration-300 ${darkMode ? "bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white" : "bg-gradient-to-br from-violet-50 via-white to-purple-50"}`}>>
      ...
      <div className="max-w-2xl mx-auto">
            ...
            <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-lg p-6 mb-6">
              <div className="flex justify-around text-center">
                ...
                <div>
                  ...
                  <p className="text-xl md:text-2xl lg:text-3xl font-bold text-violet-600">{currentNumber}</p>
                </div>
              </div>
              {/* Progress Bar */}
        ...
        {gameState === 'gameOver' && (
          ...
          >
            <div className="text-6xl mb-4">❌</div>
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-800 dark:text-white mb-4">{t('concentrationGrid.gameOver', 'Time\'s Up!')}</h2>
        ...
        {gameState === 'victory' && (
          ...
          >
            <div className="text-6xl mb-4">🎉</div>
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-violet-600 mb-4">{t('concentrationGrid.victory', 'Congratulations!')}</h2>
