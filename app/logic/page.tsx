...
const games = [
  { id: 'math-operations', icon: '➕', title: 'Math Operations', description: 'Solve math problems', difficulty: 'Easy' },
  { id: 'sudoku', icon: '🔢', title: 'Sudoku', description: 'Fill in the numbers', difficulty: 'Hard' },
  { id: 'number-sequence', icon: '📊', title: 'Number Sequence', description: 'Find the next number', difficulty: 'Medium' },
  { id: 'logic-grid', icon: '🧩', title: 'Logic Grid', description: 'Solve logical puzzles', difficulty: 'Hard' },
  { id: 'logic-puzzle', icon: '📦', title: 'Logic Puzzle', description: 'Arrange boxes using clues', difficulty: 'Medium' },
]
      ...
      <header className={`p-6 shadow-sm ${darkMode ? 'bg-slate-900' : 'bg-white'}`}>
        <div className="flex justify-between items-center">
          <div>
            ...
            <h1 className={`text-3xl font-bold ${darkMode ? 'text-white' : 'text-gray-800'}`}>🧩 {t('logic')}</h1>
          </div>
        </div>
      </header>
