  ...
  if (gameOver) {
    return (
      ...
      <SettingsPanel />
        ...
        >
          <h2 className="text-xl md:text-2xl lg:text-3xl font-bold text-gray-800 dark:text-white mb-4">Game Over!</h2>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50">
      <header className="p-6 bg-white dark:bg-slate-800 shadow-sm">
        ...
        <h1 className="text-xl md:text-2xl lg:text-3xl font-bold text-gray-800 dark:text-white">➕ Math Operations</h1>
      </header>
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="max-w-lg mx-auto text-center mb-8">
          ...
          <div className={`text-xl md:text-2xl lg:text-3xl font-bold mb-4 ${timeLeft <= 5 ? 'text-red-500' : 'text-gray-700 dark:text-gray-300'}`}>
            ⏱️ {timeLeft}s
          </div>
        </div>
        ...
        >
          ...
          <input
            ...
            className="w-full text-center text-2xl md:text-3xl lg:text-4xl font-bold p-4 border-4 border-green-500 rounded-xl focus:outline-none focus:border-green-600 text-gray-800 dark:text-white dark:border-gray-600"
            placeholder="?"
            autoFocus
