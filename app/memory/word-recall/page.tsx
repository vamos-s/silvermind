...
export default function WordRecallPage() {
  ...
  return (
    <div className={`min-h-screen p-3 md:p-4 lg:p-8 transition-colors duration-300 ${darkMode ? "bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white" : "bg-gradient-to-br from-violet-50 via-white to-pink-50 dark:from-slate-800 dark:via-slate-900 dark:to-slate-800 p-4 md:p-8"}`}>
      <SettingsPanel />
      <div className="max-w-2xl mx-auto">
        ...
        {gameState === 'menu' && (
          ...
          >
            ...
            <div className="bg-violet-50 dark:bg-slate-800 rounded-xl p-4 mb-6 text-left">
              <h3 className="font-bold text-gray-800 dark:text-white mb-2">{t('wordRecall.levelInfo', 'Level Settings')}:</h3>
        ...
        {/* Showing words */}
        {gameState === 'showing' && (
          <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-lg p-12 text-center min-h-[400px] flex flex-col justify-center">
          ...
          <>
            ...
            <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-lg p-8 mb-6">
              ...
              <textarea
                ...
                className="w-full p-6 text-2xl border-4 border-gray-300 dark:border-gray-500 rounded-xl focus:border-violet-300 focus:outline-none resize-none min-h-[200px] text-gray-800 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 dark:border-gray-600"
                autoFocus
              />
              <button
