...
export default function ColorMatchPage() {
  ...
  return (
    <div className={`min-h-screen p-3 md:p-4 lg:p-8 transition-colors duration-300 ${darkMode ? "bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white" : "bg-gradient-to-br from-rose-50 via-white to-indigo-50 dark:from-slate-800 dark:via-slate-900 dark:to-slate-800 p-4 md:p-8"}`}>
      <SettingsPanel />
        ...
        {gameState === 'menu' && (
          ...
          >
            ...
            <div className="bg-rose-50 dark:bg-slate-700 rounded-xl p-4 mb-6 text-left">
              <h3 className="font-bold text-gray-800 dark:text-white mb-2">{t('colorMatch.levelInfo', 'Level Settings')}:</h3>
