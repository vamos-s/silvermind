      ...
      <div className="max-w-2xl mx-auto">
            ...
            <div className={`${darkMode ? 'bg-slate-800' : 'bg-white'} rounded-2xl shadow-lg p-6 mb-6`}>
              <div className="flex justify-between items-center">
                ...
                <div>
                  ...
                  <p className="text-3xl font-bold text-orange-500">{totalScore}</p>
                </div>
                <div>
                  <p className={`text-sm font-medium ${darkMode ? 'text-slate-300' : 'text-gray-700'}`}>{t('mentalRotationAdvanced.timeLeft', 'Time Left')}</p>
                  <p className={`text-4xl font-bold ${timeLeft <= 10 ? 'text-red-500' : 'text-amber-500'}`}>
                    {timeLeft}s
                  </p>
                </div>
              </div>
        ...
        {gameState === 'levelComplete' && (
          ...
          >
            ...
            <h2 className={`text-4xl font-bold mb-4 ${score > 0 ? 'text-amber-500' : 'text-red-500'}`}>
              ...
              <div className={`rounded-xl p-6 mb-6 ${darkMode ? 'bg-slate-700' : 'bg-amber-50'}`}>
                ...
                <div className="grid grid-cols-2 gap-4 mt-4">
                  ...
                  <div>
                    ...
                    <p className="text-3xl font-bold text-orange-500">{totalScore + score}</p>
                  </div>
                </div>
              </div>
            ) : (
        ...
        {gameState === 'victory' && (
          ...
          >
            ...
            <h2 className="text-4xl font-bold text-amber-500 mb-4">{t('mentalRotationAdvanced.victory', 'Congratulations!')}</h2>
