      ...
      <div className="max-w-2xl mx-auto">
        ...
        {gameState === 'levelComplete' && (
          ...
          >
            ...
            <button
              onClick={nextLevel}
              className="bg-gradient-to-r from-violet-500 to-purple-500 text-white text-2xl font-bold py-4 px-12 rounded-xl hover:from-violet-600 hover:to-purple-600 shadow-lg transition-all w-full mb-3"
            >
